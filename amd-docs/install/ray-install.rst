...
To use Ray `2.55.1 <https://github.com/AMD-Ecosystem/ray/tree/release/2.55.1>`__, you need the following prerequisites:

- **ROCm version:** `7.2.1 <https://rocm.docs.amd.com/en/docs-7.2.1/>`__
- **Operating system:** Ubuntu 22.04
- **GPU platform:** AMD Instinct™ MI300X, MI325X, MI355X
- **PyTorch:** `2.10.0 <https://github.com/ROCm/pytorch/tree/release/2.10>`__
...
1. Clone the `https://github.com/AMD-Ecosystem/ray <https://github.com/AMD-Ecosystem/ray>`__ repository:
   ...
   .. code-block:: bash
      ...
      git clone https://github.com/AMD-Ecosystem/ray.git -b release/2.55.1
